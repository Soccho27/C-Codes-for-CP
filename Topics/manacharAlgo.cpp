/*
    shohag bhai template
    array ki denote kore niche comment a bola ache
    problem : https://judge.yosupo.jp/problem/enumerate_palindromes
    ekhane 2*N - 1 length output hoi karon first er ta odd length 2nd ta even length
    like aba =  a . a . b . a . a
                1 2 1 0 5 0 1 2 1 
*/
...
int32_t main() {
  ...
  int n = s.size();
  for (int i = 0; i < n; i++) {
    // 2 multiple hoise karon p emnei create hoise, upure explain kora ache
    cout << 2 * M.p[1][i] + 1 << ' ';
